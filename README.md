...
Now, in order to obtain the [PNG_match_lists](https://github.com/adamzhen/Project-Icarus-Official/tree/main/wispr_data/PNG_match_lists) and [PNG_lists](https://github.com/adamzhen/Project-Icarus-Official/tree/main/wispr_data/PNG_lists) mentioned above, I first downloaded all of the PNGs. Then, I ran a python script ([get_wispr_png_names.py](https://github.com/adamzhen/Project-Icarus-Official/blob/main/data_processing/get_wispr_png_names.py)) to compile all of the PNG names into [text files](https://github.com/adamzhen/Project-Icarus-Official/tree/main/wispr_data/PNG_lists) for each orbit & camera, and then compile those text files into [all-inner-pngs.txt](https://github.com/adamzhen/Project-Icarus-Official/blob/main/wispr_data/all-inner-pngs.txt) and [all-outer-pngs.txt](https://github.com/adamzhen/Project-Icarus-Official/blob/main/wispr_data/all-outer-pngs.txt) which I copy & pasted into [wispr_display.js](https://github.com/adamzhen/Project-Icarus-Official/blob/main/wispr_display.js) (I know, very fancy). I used another python script ([process_wispr_fits_and_png_data.py](https://github.com/adamzhen/Project-Icarus-Official/blob/main/data_processing/process_wispr_fits_and_png_data.py)) to find the matching dates between the fits & png data, and export them into text files for each camera, which I copy & pasted into [wispr_display.js](https://github.com/adamzhen/Project-Icarus-Official/blob/main/wispr_display.js).
