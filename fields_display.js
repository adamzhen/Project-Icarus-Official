...
instrumentselector4.oninput = function(){
  ...
  if (fieldsmode == "m"){ // Magnetic field
    ...
    document.getElementById("fieldsdescription").innerHTML = "The electric antennas measure both AC/DC voltage at a zippy rate of thousands of times per second. These measurements are separated out by electric field frequency into 108 bins - which is a lot of data, so I combined every 2 bins to reduce it to 54. The standard units for voltage are - you wouldn't believe it - volts. Here, they are shown in millivolts (mV): one-thousandth of a volt (in case you were wondering, this was actually converted from a fancy unit called power spectral density). And for reference, that AA battery that is constantly dying on you - that would provide about 1500 mV.";
